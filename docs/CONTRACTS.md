...
Commit `9bc87191dd90fd3d7db939127f1ebedfccd2b48d` hardens `ORB-C1`
against concurrent stale-socket claims while preserving `ORB-C2` through
`ORB-C11`. Its simultaneous-process ownership regression and canonical suite
passed at that immutable revision.
