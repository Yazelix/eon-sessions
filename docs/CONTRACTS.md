...
Commit `6de95296d252c119d4fdba2d9b03cec1a09355ae` hardens `ORB-C6` by
rejecting capability values that contradict ORBF v1 while preserving `ORB-C3`
through `ORB-C5` and `ORB-C7` through `ORB-C11`. Its canonical encode, decode,
and reducer regression plus the workspace suite passed at that exact revision.
