...
Commit `957571b69c04ae50bd1f4445fc7723bb5af05f4b` corrects the `ORB-C4`
real-PTY proof so a client that may validly disconnect under bounded output
pressure is never required to remain writable. The named proof passed 50
consecutive local runs and the complete hosted CI surface. Runtime behavior,
ORBF v1, ORBS v4, dependencies, and the other contract proofs are unchanged.
