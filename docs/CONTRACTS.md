...
The user approved `ORB-C9` as an owner-first breaking replacement of ORBS v1
with ORBS v2. Orbit implements and proves v2 first; Venus then updates its exact
...
window. Until the Orbit candidate is accepted, ORBS v1 remains the last proved
runtime boundary and the partially proved ORB-C9 row does not promote candidate
bytes.
