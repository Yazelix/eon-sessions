...
Commit `6fcf98228f9e5e6430390fe1da1c0e4bace01aed` preserves `ORB-C3`,
`ORB-C4`, `ORB-C7`, and `ORB-C11` while moving their attachment transport into
one private owner. Focused transport checks and the complete canonical suite
passed at that exact revision; protocols and dependencies are unchanged.
