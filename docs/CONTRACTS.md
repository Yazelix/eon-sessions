...
Commit `26b4b9465b3f0e74f091a0aae93fddc61412b893` remains the prior proof for
`ORB-C6` and `ORB-C10`. Commit
`83d700882ee156bac0de0112b3f1daade049b9fb` remains the prior proof for
`ORB-C1` through `ORB-C5`, `ORB-C7` through `ORB-C9`, and `ORB-C11`; their
current candidate is partial pending an accepted immutable revision.
