...
Commit `9bc87191dd90fd3d7db939127f1ebedfccd2b48d` is the current accepted proof
for `ORB-C1` through `ORB-C11`. It hardens concurrent stale-socket ownership for
`ORB-C1`, preserves the other contracts, and changes neither ORBF v1 nor ORBS
v3. Commit `cb0703010c3a4944980404b665abff795be09fb4` remains the prior proof for
the routed contracts.
