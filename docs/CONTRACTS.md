...
Commit `321c96e48c10aa6bf622ba043cc4b3816f9f4301` hardens `ORB-C2` and
`ORB-C6` with the optional bounded Eon palette launch input while preserving
the existing ORBS revision and standalone defaults.
